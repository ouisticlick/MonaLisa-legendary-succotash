...
public class ConvexPolygon extends Polygon implements Serializable {
    ...
    public Point findCentroid(List<KMeans.Point> points) {
        int x = 0;
        int y = 0;
        for (KMeans.Point p : points) {
            x += p.x;
            y += p.y;
        }
    ...
    public List<KMeans.Point> sortVerticies(List<KMeans.Point> points) {
        // get centroid
